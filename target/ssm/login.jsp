...
<BODY>
<FORM id=form1 name=form1 action="login/loginUser" method=post>
                            ...
                            <TR>
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        <TBODY>
                                        身&nbsp;&nbsp;份:&nbsp;&nbsp;
                                        管理员<input type="radio" name="user" value="管理员">
                                        学生<input type="radio" name="user" value="学生">
                                        教师<input type="radio" name="user" value="教师"><br/>
                                        <TR>
                                        ...
                                        <TR>
                                            <TD style="HEIGHT: 18px" colspan="2"><font color="red">${fall} </font></TD>
