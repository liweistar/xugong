...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 column">
            <a class="btn btn-primary" href="${path}/rebuild/toAddRebuild?code=${rebuild.code}">新增</a>
        </div>
    </div>
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-responsive table-hover dataTable no-footer">
                ...
                <tbody id="list">
                <input type="hidden" name="code" value="${rebuild.code}">
                </tbody>
            </table>
            <div>${wu}</div>
        ...
        <script type="text/javascript">
            ...
            $(function aa() {
                $.ajax({
                    url: "${pageContext.request.contextPath }/rebuild/json",
                    type: "POST",
                    data: {
                        "code": code
                    },
