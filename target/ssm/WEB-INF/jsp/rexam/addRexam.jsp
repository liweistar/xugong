...
<div class="container">
    ...
    <form id="updateForm" action="/rexam/addRexam">
        ...
        课程：<select name="rkemu" id="name" class="form-control"></select><br><br><br>
        <input class="btn btn-info" type="submit" id="addRexam" value="增加">
    </form>
