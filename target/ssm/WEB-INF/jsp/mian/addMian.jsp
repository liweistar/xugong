...
<div class="container">
    ...
    <form id="updateForm" action="/mian/addMian">
        ...
        课程：<select name="kemu" id="name" class="form-control"></select><br><br><br>
        凭证：<input type="text" name="ping" class="form-control"><br><br><br>
        <input class="btn btn-info" type="submit" id="addMian" value="增加">
    </form>
